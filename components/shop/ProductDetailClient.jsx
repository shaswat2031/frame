        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div className="space-y-16 lg:py-6">
            <header className="space-y-8">
              ...
              >
                <span className="text-5xl font-light tracking-widest text-gold drop-shadow-lg">₹{product.price?.toLocaleString()}</span>
              ...
              <div className="bg-navy-surface/40 p-8 border border-gold/15 rounded-sm space-y-6">
                ...
                <div className="space-y-5">
                  <div className="flex items-center gap-4 text-xs font-mono tracking-widest text-cream/70">
                    ...
                    <span>Selected: {product.name} — <span className="text-gold font-bold">₹{product.price?.toLocaleString()}</span></span>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-gold/10 flex flex-col sm:flex-row justify-between items-center gap-6">
                  <div className="space-y-1">
                    ...
                    <span className="text-3xl font-light tracking-widest text-gold font-bold">₹{product.price?.toLocaleString()}</span>
                  </div>
                ...
                <Link href={`/shop/${p.id}`} className="group flex flex-col">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center pt-3 border-t border-cream/5">
                      ...
                      <span className="text-xl tracking-widest font-bold text-gold">₹{p.price?.toLocaleString()}</span>
                    </div>
                  </div>
                </Link>
              </motion.div>
