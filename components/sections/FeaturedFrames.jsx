    ...
    <section className="py-24 bg-navy">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12 md:mb-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-light text-cream font-serif tracking-tight">New Arrivals</h2>
            ...
            >
              <div className="relative aspect-[4/3] bg-navy-surface border border-gold/5 overflow-hidden flex items-center justify-center p-4 md:p-12">
                ...
                <div className="w-full h-full bg-[radial-gradient(circle_at_center,rgba(201,168,76,0.05)_0%,transparent_70%)] flex items-center justify-center">
                  <svg width="100%" height="auto" viewBox="0 0 240 120" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gold/20 group-hover:text-gold/40 transition-colors duration-500 max-w-[240px]">
                ...
                <div className="absolute inset-0 bg-navy/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col gap-2 md:gap-3 items-center justify-center p-2">
                  <button 
                    ...
                    className="w-full max-w-[140px] md:max-w-[160px] bg-cream text-navy py-2 md:py-3 text-[8px] md:text-[10px] uppercase tracking-widest font-bold hover:bg-gold transition-colors"
                  >
                    Try Virtually
                  </button>
                  <button 
              ...
              <div className="mt-4 md:mt-6 space-y-1.5 md:space-y-2 relative">
                ...
                <div className="flex flex-wrap items-center gap-1.5 md:gap-3">
                  <span className="text-[10px] sm:text-xs md:text-base text-gold font-accent tracking-wider">Rs. {product.price}</span>
                  {product.oldPrice && (
                    <span className="text-cream/30 text-[8px] md:text-sm line-through">Rs. {product.oldPrice}</span>
                  )}
                </div>
